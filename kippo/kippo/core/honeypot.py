...
class HoneyPotShell(object):
    ...
    # my mod to show a banner when logged in
    def showBanner(self):
        for l in (
            ...
            '  Usage of /:   9.1% of 19.56GB   Users logged in:     1',
            '  Memory usage: 36%               IP address for eth0: 10.98.55.255',
            '  Swap usage:   0%',
            '',
...
class HoneypotPasswordChecker:
    ...
    def checkPamUser(self, username, pamConversion):
        # my mod to make a better prompt
        # todo should parse rather then hardcode ip
        r = pamConversion((("%s@10.98.55.255's Password:" % username, 1),))
