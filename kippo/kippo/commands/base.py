...
class command_ps(HoneyPotCommand):
    def call(self):
        ...
        args = ''
        mypid = 5679 + int(str(time.time()).split('.')[0][-2:])
        if len(self.args):
            args = self.args[0].strip()
        _user, _pid, _cpu, _mem, _vsz, _rss, _tty, _stat, \
            _start, _time, _command, _ppid = range(12)
        output = (
            ('USER      ', ' PID', ' %CPU', ' %MEM', '    VSZ', '   RSS', ' TTY      ', 'STAT ', '  START', '   TIME ', 'COMMAND', ' PPID',),
            ('root      ', '   1', '  0.0', '  0.1', '   2100', '   688', ' ?        ', 'Ss   ', '  Dec09', '   0:07 ', 'init [2]  ', '    0',),
            ('root      ', '   2', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kthreadd]', '    0',),
            ('root      ', '   3', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[migration/0]', '    2',),
            ('root      ', '   4', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[ksoftirqd/0]', '    2',),
            ('root      ', '   5', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[watchdog/0]', '    2',),
            ('root      ', '   6', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:17 ', '[events/0]', '    2',),
            ('root      ', '   7', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[khelper]', '    2',),
            ('root      ', '  39', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kblockd/0]','    2',),
            ('root      ', '  41', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kacpid]', '    2',),
            ('root      ', '  42', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kacpi_notify]', '    2',),
            ('root      ', ' 170', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kseriod]', '    2',),
            ('root      ', ' 207', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S    ', '  Dec09', '   0:01 ', '[pdflush]', '    2',),
            ('root      ', ' 208', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S    ', '  Dec09', '   0:00 ', '[pdflush]', '    2',),
            ('root      ', ' 209', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kswapd0]', '    2',),
            ('root      ', ' 210', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[aio/0]', '    2',),
            ('root      ', ' 748', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[ata/0]', '    2',),
            ('root      ', ' 749', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[ata_aux]', '    2',),
            ('root      ', ' 929', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[scsi_eh_0]', '    2',),
            ('root      ', '1014', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'D<   ', '  Dec09', '   0:03 ', '[kjournald]', '    2',),
            ('root      ', '1087', '  0.0', '  0.1', '   2288', '   772', ' ?        ', 'S<s  ', '  Dec09', '   0:00 ', 'udevd --daemon', '    2',),
            ('root      ', '1553', '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  Dec09', '   0:00 ', '[kpsmoused]', '    2',),
            ('root      ', '2054', '  0.0', '  0.2', '  28428', '  1508', ' ?        ', 'Sl   ', '  Dec09', '   0:01 ', '/usr/sbin/rsyslogd -c3', '    1',),
            ('root      ', '2103', '  0.0', '  0.2', '   2628', '  1196', ' tty1     ', 'Ss   ', '  Dec09', '   0:00 ', '/bin/login --     ', '    1',),
            ('root      ', '2105', '  0.0', '  0.0', '   1764', '   504', ' tty2     ', 'Ss+  ', '  Dec09', '   0:00 ', '/sbin/getty 38400 tty2', '    1',),
            ('root      ', '2107', '  0.0', '  0.0', '   1764', '   504', ' tty3     ', 'Ss+  ', '  Dec09', '   0:00 ', '/sbin/getty 38400 tty3', '    1',),
            ('root      ', '2109', '  0.0', '  0.0', '   1764', '   504', ' tty4     ', 'Ss+  ', '  Dec09', '   0:00 ', '/sbin/getty 38400 tty4', '    1',),
            ('root      ', '2110', '  0.0', '  0.0', '   1764', '   504', ' tty5     ', 'Ss+  ', '  Dec09', '   0:00 ', '/sbin/getty 38400 tty5', '    1',),
            ('root      ', '2112', '  0.0', '  0.0', '   1764', '   508', ' tty6     ', 'Ss+  ', '  Dec09', '   0:00 ', '/sbin/getty 38400 tty6', '    1',),
            ('root      ', '2133', '  0.0', '  0.1', '   2180', '   620', ' ?        ', 'S<s  ', '  Dec09', '   0:00 ', 'dhclient3 -pf /var/run/dhclient.eth0.pid -lf /var/lib/dhcp3/dhclien', '    1'),
            ('root      ', '4969', '  0.0', '  0.1', '   5416', '  1024', ' ?        ', 'Ss   ', '  Dec15', '   0:00 ', '/usr/sbin/sshd: %s@pts/0' % user, '    1',),
            ('root      ', '5328', '  0.0', '  0.0', '      0', '     0', ' tty1     ', 'Ss+  ', '  Jan05', '   6:55 ', '[kworker/u2:1]', '    2',),
            ('%s'.ljust(8) % user, '5673', '  0.0', '  0.2', '   2924', '  1540', ' pts/0    ', 'Ss   ', '  04:30', '   0:00 ', '-bash', ' 4969',),
            ('%s'.ljust(8) % user, '%s' % mypid, '  0.0', '  0.1', '   2432', '   928', ' pts/0    ', 'R+   ', '  04:32', '   0:00 ', 'ps %s' % ' '.join(self.args), ' 5673',)
            )
        for i in range(len(output)):
            if i != 0:
                if 'a' not in args and output[i][_user].strip() != user:
                    continue
                # my mod to allow for ps ef
            ...
            if 'a' in args or 'x' in args:
                ...
                l = [_user, _pid, _ppid, _cpu, _start, _tty, _time, _command]
            if 'u' in args:
